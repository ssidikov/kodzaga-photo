      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-28 items-center">
        ...
        <ScrollReveal>
          <div className="relative">
            <div className="relative overflow-hidden bg-surface w-full aspect-[3/4] flex items-center justify-center">
              {/* Placeholder — replace with actual portrait */}
              <div className="w-full h-full bg-gradient-to-br from-surface-light via-surface to-bg flex items-center justify-center">
                <span className="font-heading text-6xl gold-text opacity-20">AK</span>
              </div>
            </div>
        ...
        <ScrollReveal delay={120}>
          <div>
            ...
            <p className="font-body text-cream/50 text-[14.5px] leading-[1.9] font-light mb-5">
              Passionné par l&apos;image et la direction artistique, je capture
              l&apos;essence de chaque instant avec un regard cinématographique
              unique.
            </p>
            <p className="font-body text-cream/50 text-[14.5px] leading-[1.9] font-light mb-10">
              Spécialisé en portraits lifestyle et shootings contrastés, je
              propose une approche créative et sur-mesure pour sublimer chaque
              projet.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4 pb-10 border-b border-white/5 mb-10">
              <div className="text-center">
                <div className="font-heading text-3xl font-semibold gold-text mb-1">
                  3
                </div>
