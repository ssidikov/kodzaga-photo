      ...
      <div className='max-w-4xl mx-auto relative z-10'>
        ...
        <div className='mb-16'>
          ...
          <p className='text-cream/50 text-sm font-light leading-relaxed max-w-xl'>
            ...
            vos données personnelles sont collectées, traitées et protégées sur le site
            al3x-photos.fr.
          </p>
        </div>
        ...
        <div className='space-y-8'>
          ...
          <div className='bg-surface border border-gold/[0.06] p-8 md:p-10 relative'>
            ...
            <div className='flex items-start gap-4'>
              ...
              <div className='space-y-4'>
                <h2 className='font-heading text-xl text-cream font-medium'>
                  1. Responsable du traitement
                </h2>
                <div className='text-cream/60 text-sm font-light leading-relaxed'>
                  <p>
                    Le traitement des données personnelles collectées sur le site est effectué sous
                    la responsabilité de{' '}
                    <strong className='text-cream font-medium'>Monsieur Alexis Kodzaga</strong>, en
                    sa qualité d&apos;éditeur et responsable du site.
                  </p>
                  <p className='mt-2'>
                    Pour toute question relative à la protection de vos données, vous pouvez nous
                    écrire à l&apos;adresse suivante :{' '}
                    <a
                      href='mailto:contact@al3x-photos.fr'
                      className='gold-text hover:underline transition-all'>
                      contact@al3x-photos.fr
                    </a>
                    .
                  </p>
                </div>
            ...
            <div className='flex items-start gap-4'>
              ...
              <div className='space-y-4'>
                ...
                <div className='text-cream/60 text-sm font-light space-y-3 leading-relaxed'>
                  <p>
                    Nous collectons uniquement les données personnelles que vous nous fournissez
                    volontairement lors de l&apos;envoi du formulaire de contact et de réservation :
                  </p>
                  <ul className='list-disc pl-5 space-y-1.5 text-cream/50'>
                    <li>
                      <strong className='text-cream/70 font-medium'>Identité :</strong> Nom complet.
                    </li>
                    <li>
                      <strong className='text-cream/70 font-medium'>Coordonnées :</strong> Adresse
                      e-mail, numéro de téléphone.
                    </li>
                    <li>
                      <strong className='text-cream/70 font-medium'>Détails du projet :</strong>{' '}
                      Prestation souhaitée, date souhaitée, lieu, options choisies et message
                      rédigé.
                    </li>
                  </ul>
                  <p className='text-[13px] text-cream/40 italic'>
                    Aucune donnée dite &quot;sensible&quot; (données de santé, opinions politiques,
                    etc.) n&apos;est collectée ou demandée.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className='bg-surface border border-gold/[0.06] p-8 md:p-10 relative'>
            ...
            <div className='flex items-start gap-4'>
              ...
              <div className='space-y-4'>
                <h2 className='font-heading text-xl text-cream font-medium'>
                  4. Durée de conservation et destinataires
                </h2>
                <div className='text-cream/60 text-sm font-light space-y-3 leading-relaxed'>
                  <p>
                    <strong className='text-cream font-medium'>Destinataires :</strong> Vos données
                    sont destinées à l&apos;usage exclusif de Monsieur Alexis Kodzaga. Elles ne sont
                    jamais vendues, louées ou transmises à des tiers à des fins publicitaires ou
                    commerciales.
                  </p>
                  <p>
                  ...
                  <ul className='list-disc pl-5 space-y-1.5 text-cream/50'>
                    <li>
                      Pour les simples demandes de devis ou de renseignements n&apos;ayant pas
                      abouti à un contrat : conservation pour une durée maximale de{' '}
                      <strong className='text-cream/70'>3 ans</strong> à compter du dernier contact
                      de votre part.
                    </li>
                    <li>
                      Pour les clients ayant réalisé une prestation : conservation pendant toute la
                      durée de la relation contractuelle, puis archivage pour les durées légales de
                      conservation des factures et contrats (10 ans).
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className='bg-surface border border-gold/[0.06] p-8 md:p-10 relative'>
            ...
            <div className='flex items-start gap-4'>
              ...
              <div className='space-y-4'>
                ...
                <div className='text-cream/60 text-sm font-light space-y-3 leading-relaxed'>
                  <p>
                    Conformément aux réglementations européenne (RGPD) et française (loi
                    Informatique et Libertés), vous disposez des droits suivants :
                  </p>
                  <ul className='list-disc pl-5 space-y-1.5 text-cream/50'>
                    <li>
                      <strong className='text-cream/70 font-medium'>Droit d&apos;accès :</strong>{' '}
                      obtenir la confirmation que des données vous concernant sont traitées.
                    </li>
                    <li>
                      <strong className='text-cream/70 font-medium'>
                        Droit de rectification :
                      </strong>{' '}
                      demander la mise à jour ou correction de vos données.
                    </li>
                    <li>
                      <strong className='text-cream/70 font-medium'>
                        Droit à l&apos;effacement (&quot;droit à l&apos;oubli&quot;) :
                      </strong>{' '}
                      demander la suppression de vos données personnelles sous réserve des
                    ...
                    <li>
                      ...
                      demander à restreindre ou vous opposer au traitement de vos données.
                    </li>
                  </ul>
                  <p className='mt-4'>
                    Vous pouvez exercer ces droits en contactant Monsieur Alexis Kodzaga par e-mail
                    à :{' '}
                    <a
                      href='mailto:contact@al3x-photos.fr'
                      className='gold-text hover:underline transition-all'>
                ...
                <div className='text-cream/60 text-sm font-light space-y-3 leading-relaxed'>
                  ...
                  <p>
                    <strong className='text-cream font-medium'>
                      Traceurs analytiques et publicitaires :
                    </strong>{' '}
                    Aucun cookie tiers (de type Google Analytics, Facebook Pixel, etc.) n&apos;est
