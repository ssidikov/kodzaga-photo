      ...
      <div className='max-w-4xl mx-auto relative z-10'>
        ...
        <div className='mb-16'>
          ...
          <p className='text-cream/50 text-sm font-light leading-relaxed max-w-xl'>
            ...
            pour la confiance dans l&apos;économie numérique (LCEN), voici les mentions légales du
            site al3x-photos.fr.
          </p>
        </div>
            ...
            <div className='flex items-start gap-4'>
              ...
              <div className='space-y-4'>
                ...
                <div className='text-cream/60 text-sm font-light space-y-2 leading-relaxed'>
                  <p>
                    <strong className='text-cream font-medium'>Nom de l&apos;entreprise :</strong>{' '}
                    Alexis Kodzaga (Entrepreneur Individuel)
                  </p>
                  <p>
                    <strong className='text-cream font-medium'>Adresse du siège social :</strong> 34
                    rue de la Croix, 95220 Herblay-sur-Seine, France
                  </p>
                  <p>
                    <strong className='text-cream font-medium'>Immatriculation :</strong> Entreprise
                    enregistrée sous le numéro SIREN{' '}
                    <span className='text-gold/80 font-medium'>100 928 357</span> (SIRET :
                    10092835700019)
                  </p>
                  <p>
            ...
            <div className='flex items-start gap-4'>
              ...
              <div className='space-y-4'>
                ...
                <div className='text-cream/60 text-sm font-light leading-relaxed'>
                  <p>
                    Le directeur de la publication et responsable de la rédaction du site est{' '}
                    <strong className='text-cream font-medium'>Monsieur Alexis Kodzaga</strong>, en
                    sa qualité d&apos;éditeur et de propriétaire du site.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className='space-y-4'>
                ...
                <div className='text-cream/60 text-sm font-light space-y-2 leading-relaxed'>
                  <p>
                    ...
                    <strong className='text-cream font-medium'>Vercel Inc.</strong>
                  </p>
                  <p>
                    <strong className='text-cream font-medium'>Adresse :</strong> 650 2nd St, San
            ...
            <div className='flex items-start gap-4'>
              ...
              <div className='space-y-4'>
                ...
                <div className='text-cream/60 text-sm font-light space-y-4 leading-relaxed'>
                  <p>
                    Alexis Kodzaga est propriétaire des droits de propriété intellectuelle ou
                    détient les droits d&apos;usage sur tous les éléments accessibles sur le site
                    internet, notamment les textes, photographies, vidéos, graphismes, logos, icônes
                    et sons.
                  </p>
                  <p>
          ...
          <div className='bg-surface border border-gold/[0.06] p-8 md:p-10 relative'>
            ...
            <div className='flex items-start gap-4'>
              ...
              <div className='space-y-4'>
                ...
                <div className='text-cream/60 text-sm font-light space-y-4 leading-relaxed'>
                  <p>
                    Ce site n&apos;utilise aucun cookie tiers de suivi publicitaire ou
                    d&apos;analyse d&apos;audience (analytics).
                  </p>
                  <p>
                    Les informations recueillies via le formulaire de contact (nom complet, email,
                    téléphone, date, lieu, prestation et message) sont traitées de manière
                    confidentielle et servent uniquement à répondre aux demandes de devis ou de
                    renseignements.
                  </p>
                  <p>
                    Conformément à la réglementation RGPD, vous disposez d&apos;un droit
                    d&apos;accès, de rectification, de portabilité et de suppression de vos données
                    personnelles. Vous pouvez exercer ce droit à tout moment par e-mail à
                    l&apos;adresse suivante :{' '}
                    <a
                      href='mailto:contact@al3x-photos.fr'
                      className='gold-text hover:underline transition-all'>
